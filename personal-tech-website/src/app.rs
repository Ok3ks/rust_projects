...
use chrono::{Utc};
use leptos_meta::*;
use leptos_meta::{Title, Stylesheet, provide_meta_context};
use leptos_router::path;
use leptos_router::hooks::{use_navigate, use_query_map, use_params_map};
...
fn Editor() -> impl IntoView {
    ...
    let input_element = NodeRef::<Textarea>::new();
